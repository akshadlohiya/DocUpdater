      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="bg-[rgba(10,15,20,0.8)] w-[400px] p-10 rounded-3xl border border-white/10 text-center shadow-[0_25px_50px_rgba(0,0,0,0.5)] backdrop-blur-[15px]">
          ...
          <div className="flex bg-[#1a1f24] my-6 rounded-xl p-1.5">
            <label
              className={`flex-1 py-2.5 cursor-pointer transition-all rounded-lg text-sm ${
                role === 'user'
          ...
          <div>
            <h2 className="text-xl mb-4">{authTitle}</h2>
            <form onSubmit={handleSubmit}>
              ...
              {error && (
                <div className="my-3 p-3 bg-red-500/20 border border-red-500/50 rounded-lg text-red-300 text-sm">
                  {error}
                </div>
              )}
